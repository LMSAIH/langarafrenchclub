...
const HeroSection = ({ title, aboutText }: HeroSectionProps) => {
  return (
    <div className="relative min-h-screen 4xl:min-h-[800px] flex items-center">
      {/* Background Image */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl">
            ...
            >
              <Link
                href="/Events"
                className="relative group inline-block bg-frenchBlue text-white font-semibold py-3 px-10 rounded-xl hover:bg-blue-800 transition-all duration-300 shadow-xl transform hover:scale-105 border-b-4 border-blue-900"
              >
