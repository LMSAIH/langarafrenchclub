    ...
    clubFounders: [
      {
        ...
        bio: "Aurora, the President and Co-Founder of the Langara French Club, played a key role in standardizing procedures and driving innovative initiatives. Always multitasking with ease, you'll often find her sipping coffee, engrossed in a book, checking in with members, and crafting the next to-do list—all at the same time! ",
      ...
      {
        name: "Axel Velasquez",
        role: "Vicepresident & Head of IT",
        bio: "Axel, as Vicepresident & Head of IT, now leads our executive team and manages all technical operations. His leadership and technical expertise ensure the club runs smoothly and stays innovative.",
    ...
    clubFounders: [
      {
        ...
        bio: "Aurora, président et cofondateur du Langara French Club, a joué un rôle clé dans la normalisation des procédures et la mise en place d'initiatives innovantes. Toujours multitâches, vous la trouverez souvent en train de siroter un café, de lire un livre, de prendre des nouvelles des membres et de dresser la prochaine liste de choses à faire - tout cela en même temps !",
        imageUrl: `${currentExecPath}/aurora.webp`,
      },
      {
        name: "Kareena Mistry",
      ...
      {
        name: "Axel Velasquez",
        role: "Vice-président & Responsable informatique",
        bio: "Axel, en tant que vice-président et responsable informatique, dirige désormais notre équipe exécutive et gère toutes les opérations techniques. Son leadership et son expertise assurent le bon fonctionnement et l'innovation du club.",
        imageUrl: `${currentExecPath}/axel.webp`,
      },
    ],
    currentExecs: [
